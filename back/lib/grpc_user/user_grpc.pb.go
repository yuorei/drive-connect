...
func (c *userServiceClient) DeleteUser(ctx context.Context, in *ID, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedUserServiceServer) DeleteUser(context.Context, *ID) (*empty.Empty, error) {
