...
type BoardServiceClient interface {
	...
	ReadBoard(ctx context.Context, in *BoardID, opts ...grpc.CallOption) (*Board, error)
	...
	DeleteBoard(ctx context.Context, in *BoardID, opts ...grpc.CallOption) (*emptypb.Empty, error)
	CreateComment(ctx context.Context, in *Comment, opts ...grpc.CallOption) (*Comment, error)
	ReadComment(ctx context.Context, in *BoardID, opts ...grpc.CallOption) (*Comment, error)
	...
	DeleteComment(ctx context.Context, in *BoardID, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *boardServiceClient) ReadBoard(ctx context.Context, in *BoardID, opts ...grpc.CallOption) (*Board, error) {
	out := new(Board)
...
func (c *boardServiceClient) DeleteBoard(ctx context.Context, in *BoardID, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *boardServiceClient) ReadComment(ctx context.Context, in *BoardID, opts ...grpc.CallOption) (*Comment, error) {
	out := new(Comment)
...
func (c *boardServiceClient) DeleteComment(ctx context.Context, in *BoardID, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (UnimplementedBoardServiceServer) ReadBoard(context.Context, *BoardID) (*Board, error) {
...
func (UnimplementedBoardServiceServer) DeleteBoard(context.Context, *BoardID) (*emptypb.Empty, error) {
...
func (UnimplementedBoardServiceServer) ReadComment(context.Context, *BoardID) (*Comment, error) {
...
func (UnimplementedBoardServiceServer) DeleteComment(context.Context, *BoardID) (*emptypb.Empty, error) {
...
func _BoardService_ReadBoard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BoardServiceServer).ReadBoard(ctx, req.(*BoardID))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BoardService_DeleteBoard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BoardServiceServer).DeleteBoard(ctx, req.(*BoardID))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BoardService_ReadComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BoardServiceServer).ReadComment(ctx, req.(*BoardID))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BoardService_DeleteComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BoardServiceServer).DeleteComment(ctx, req.(*BoardID))
	}
	return interceptor(ctx, in, info, handler)
}
